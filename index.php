...
<html>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-6">
					...
					<button id="newTask" type="button" class="btn btn-primary btn-lg" style="width:100%;margin-bottom: 5px;" data-toggle="modal" data-target="#myModal">Add Task</button>
	...
	<script type="text/javascript">
		...
		$('#saveTask').click(function()
		{
			...
			$.post("update_task.php", {ID: currentTaskId, TaskName : $("#InputTaskName").val(), TaskDesc: $("#InputTaskDescription").val(),type: 2}).done(function() {
				updateTaskList();
			});
			$("#InputTaskName").val("");
		...
		{
			//Assignment: Implement this functionality
			$.post("update_task.php", {ID: currentTaskId, type: 1}).done(function() {
				updateTaskList();
			});
			$("#InputTaskName").val("");
			$("#InputTaskDescription").val("");
